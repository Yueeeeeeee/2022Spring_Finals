...
data_pic2 = pd.read_excel('./data/hours.xlsx').values
data1 = []
data2 = []
data3 = []
...
data_pic3 = pd.read_excel('./data/unemployment.xlsx').values
...
data_pic4 = pd.read_excel('./data/gdp.xlsx').values
...
data_pic5 = pd.read_excel('./data/welfare.xlsx').values
